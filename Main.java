...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(user1.nDestroyed != nbBoats && user2.nDestroyed != nbBoats) {  			
			...
			while( us2 == 1 || us2 == 2 || us2 == 3) {
				...
				us2 = user2.shootM(user1);
				if(us2 != 3) {									// if it is not an error 
					if ( us2 == 2) user2.nDestroyed++;
					if( us2 == 1 ) System.out.println("Machine shot your boat ! It makes a move again. ");
					if ( us2 == 2) { user2.nDestroyed++; System.out.println("Machine sanked your boat!!! It makes a move again. ");}
					if(user2.nDestroyed == nbBoats) {                                 
						System.out.println("Machine won!");
						System.exit(0);
					}
					if(us2 != 1 && us2 != 2) {
						System.out.println("Machine didnt shoot a boat");
					}
				}
			}				
		}
	...
	public static void changeTurn() {
		System.out.println("Press enter to give turn to  Machine");
		try {
			System.in.read();
		} catch (IOException e) {
			e.printStackTrace();

...
public class Grid {
    ...
    /*
    public void addShoot(int x,int y,int shot) {
    		// if shot == 2 => put all 
    	//	System.out.println("shot is " + shot+" nBoats is "+nBoats);
    		...
    		if(shot == 2) {
        		...
        		System.out.println("I didnt return ..../n/n/n\n\n\n");
    		}
    			
    		else this.board[x][y] = shot;        
    }*/
    
    public int checkShoot(int x, int y) { 	
    	if ( this.board[x][y] == -1) { 
    		this.board[x][y] = 0;
    		return 0; 
    	}
